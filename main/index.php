...
.wrapper.form-success .container h1 {
  -webkit-transform: translateY(85px);
          transform: translateY(85px);
          	background: url('https://ocasionnautica.xyz/templates/ocasionnautica/images/ajax-loader-tennis.gif');
...
<div class="wrapper">
	...
	<div class="container">
		...
		<div class="row" style="z-index:100;">
			<div class="col-xs-4" style="z-index:100;">
				<a href="android.apk"><img src="images/android.svg.png" style="z-index:100;"/></a>
				<h4>Android App</h4>
			</div>
			<div class="col-xs-4">
				<h2>Register</h2>
			...
			<div class="col-xs-4" style="z-index:100;">
				<a href=""><img src="images/apple.png" style="z-index:100;"/></a>
				<h4>Coming Soon</h4>
			</div>
		</div>
<?php
