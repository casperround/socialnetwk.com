...
<body>
	...
	<div class="CreatePageCont">
		<div class="CPageCont1">
			<form id="upload" method="post"  class="form-horizontal"action="http://www.socialnetwk.com/home/cpageuplogo.php" enctype="multipart/form-data">
				<fieldset>
					...
					$pagedetailsload = $db->query("SELECT * FROM pages WHERE id='".$pid."'");?>
...
<center><h4>Editing: <?= $pagedetails->pname ?></h4></center>
		...
		<input class="FileSelect" type="file" name="fileToUpload" id="fileToUpload" />
						...
						<input type="text" id="relation" name="relation" class="MsgInputHidden" value="page_b_picture" />
