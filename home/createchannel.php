...
<head>
	<!-- META -->
	<title>Socialnetwk - Create Channel</title>
    <meta charset="utf-8">
...
<body>
	...
	<script>
$("#checkurl").click(function(e) {
  e.preventDefault();
  var purl = $("#purl").val(); 
  var dataString = 'purl='+purl;
  $.ajax({
    type:'POST',
    data:dataString,
    url:'http://www.socialnetwk.com/home/purlcheck.php',
	...
	<div class="CreatePageCont">
		<div class="CPageCont1">
			...
			<div class="PageDetails">
				...
				<div class="hr" style="width:100%;margin-top:15px;"><div class="hr-dot"></div></div>
				<h5>Url</h5>
				<input class="CPageInput" name="purl"  type="text"placeholder="www.socialnetwk.com/channel/cineabove"/>
									<button class="CheckUrlBtn" id="checkurl">Check Availability</button> 
				<div class="hr" style="width:100%;margin-top:15px;"><div class="hr-dot"></div></div>
