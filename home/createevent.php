...
<body>
	...
	<div class="CreatePageCont">
		<div class="CPageCont1">
				<form id="upload" method="post"  class="form-horizontal"action="http://www.socialnetwk.com/home/ceventpost.php" enctype="multipart/form-data">
				<fieldset>
			<div class="PageDetails">
				<center><h4>Details</h4></center>
				<h5>Name</h5>
				<input class="CPageInput" name="pname"  type="text"placeholder="Name"/>
				<div class="hr" style="width:100%;margin-top:15px;"><div class="hr-dot"></div></div>
				<h5>Category</h5>
				<input class="CPageInput" name="pcategory"  type="text"placeholder="Category"/>
				<div class="hr" style="width:100%;margin-top:15px;"><div class="hr-dot"></div></div>
				<h5>Details</h5>
				<input class="CPageInput" name="pdetails"  type="text"placeholder="Details"/>
				<div class="hr" style="width:100%;margin-top:15px;"><div class="hr-dot"></div></div>
				<h5>About</h5>
				<input class="CPageInput" name="pabout"  type="text"placeholder="About"/>
				<div class="hr" style="width:100%;margin-top:15px;"><div class="hr-dot"></div></div>
			</div>
		</div>
		<div class="CPageCont2">
			<div class="PageContent">
				<center><h4>More Details</h4></center>
				<h5>Country</h5>
				...
				<div class="hr" style="width:100%;margin-top:15px;"><div class="hr-dot"></div></div>
				<h5>Website</h5>
				<input class="CPageInput" name="pcategory" type="text"  placeholder="www.examplepage.com"/>
				<div class="hr" style="width:100%;margin-top:15px;"><div class="hr-dot"></div></div>
				<h5>Youtube Event</h5>
				<input class="CPageInput" name="pdetails"  type="text" placeholder="www.youtube.com/"/>
				<div class="hr" style="width:100%;margin-top:15px;"><div class="hr-dot"></div></div>
				<h5>Facebook PEventage</h5>
				<input class="CPageInput" name="pabout"  type="text" placeholder="www.facebook.com/"/>
				<div class="hr" style="width:100%;margin-top:15px;"><div class="hr-dot"></div></div>
			</div>
		</div>
		<div class="CPageCont3">
			<div class="PageUpload">
				<center><h4>Design</h4></center>
				<h5>Background</h5>
				<input class="CPageInput" name="pname"  type="file" placeholder="Name"/>
				<div class="hr" style="width:100%;margin-top:15px;"><div class="hr-dot"></div></div>
				<h5>Header Image</h5>
				<input class="CPageInput" name="pcategory" type="file"  placeholder="Category"/>
				<div class="hr" style="width:100%;margin-top:15px;"><div class="hr-dot"></div></div>
				<h5>Logo</h5>
				<input class="CPageInput" name="pdetails" type="file" placeholder="Details"/>
				<div class="hr" style="width:100%;margin-top:15px;"><div class="hr-dot"></div></div>
								<center><button class="SettingsBtn" style="border:0px;width:40%;height:50px;font-size:20px;">Create!</button></center>

			</div>
		</div>
		<div class="CPageCont4">
			<div class="PageInvite">
				<center><h4>Invite Friends</h4></center>
				<h5>Name</h5>
				<input class="CPageInput" name="pname" placeholder="Name"/>
				<div class="hr" style="width:100%;margin-top:15px;"><div class="hr-dot"></div></div>
				<h5>Category</h5>
				<input class="CPageInput" name="pcategory" placeholder="Category"/>
				<div class="hr" style="width:100%;margin-top:15px;"><div class="hr-dot"></div></div>
				<h5>Details</h5>
				<input class="CPageInput" name="pdetails" placeholder="Details"/>
				<div class="hr" style="width:100%;margin-top:15px;"><div class="hr-dot"></div></div>
				<h5>About</h5>
				<input class="CPageInput" name="pabout" placeholder="About"/>
				<div class="hr" style="width:100%;margin-top:15px;"><div class="hr-dot"></div></div>
			</div>
		</div>
		</fieldset>
