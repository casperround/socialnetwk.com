...
?></h1>
      ...
      <div class="DVRFooter">
        <h6><?php
	$tags_load = $con->query("SELECT * FROM hashtags WHERE post_id='".$feed->post_id."' AND uid='".$feed->userID."'");?><?php while($tags = $tags_load->fetch_object()): ?><a href="http://www.socialnetwk.com/home/discoversearch.php?discover=<?= $tags->tag ?>">#<?= $tags->tag ?><?php endwhile;?></a></h6>
