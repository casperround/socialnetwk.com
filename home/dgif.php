...
<div class="SideNav">
  ...
  <a href="dgif.php"><div class="DisSphereActive">
...
$MediaTxtNew = preg_replace('/<iframe.*?\/iframe>/i','', $newCaption); ?>
    <div class="DVRLoopCnt">
      <div class="DVRHeader">
        <img class="DVRUIMG" src="http://www.infobarrel.com/media/image/153474_max.png"/>
      ...
      <div class="DVRMainCnt">
         ...
         <div class="DVRContent">
          ...
          <h5>Casper Round</h5>
        <h6>Posted on Wed 26th December at 2:30pm</h6>
          <h5>Cat HD</h5>
        </div>
          <<?= $feed->format ?> alt=""  style="color:black;text-transform: capitalize;" class="FeedRCntSize" class="DVRImgR" id="video" data-setup='{"example_option":true}' src="http://www.socialnetwk.com/media/<?=$feed->file_format?>/<?=$feed->post_id?><?=$feed->author_id?>.<?=$feed->file_format?>" controls onerror="this.src='default.png'"/> 
</<?= $feed->format ?>>
        </div>
        <div class="DVRFooter">
          <h6><?php
