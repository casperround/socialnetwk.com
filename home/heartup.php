...
$ip = $_POST['ip'];
					...
					$UsrFName = $_POST['postid'];
					$UsrLName = $_POST['UsrLName'];
					$UsrID = $_POST['UsrID'];
					$author_id = $_POST['author_id'];
					$relation = 'heart';
					$heartup = $_POST['heart_up'];
					$post_id = $_POST['postid'];
										$format = $_POST['format'];
					$file_format = $_POST['file_format'];
			$sql = "INSERT INTO media (ip,date,time,firstname,lastname,userID,post_id,author_id,relation,heart_up,format,file_format) VALUES
					...
					':sasdhadka'=>$post_id,':sasdhadkas'=>$author_id,':sasdhadkasdas'=>$relation,':sashasdas'=>$heartup,':sgraegsfdefw'=>$format,':efwsadef'=>$file_format));
