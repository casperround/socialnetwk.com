...
// new data
			...
			$sql = "INSERT INTO pages (pname,pcategory,pdetails,pabout,country,pwebsite,pyoutube,pfacebook,uID,author_id,page_id) VALUES
	...
	header('Location: http://www.socialnetwk.com/home/page.php?id='.$page_id.'');	
