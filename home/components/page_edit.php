...
<div class="User_Settings_Container" >
  ...
  $pages_load = $con->query("SELECT * FROM pages WHERE id = ".$pageID." AND user_id = ".$UsrID." ");?>
<?php while($pageloaded = $pages_load->fetch_object()): ?>	
							<form id="upload" method="post" action="elements/pageupdateup.php" enctype="multipart/form-data">
							<h6>Name</h6>
							<input placeholder="Name" name="name" type="text" value="<?= $pageloaded->name?>"/></br>
							<input placeholder="Name" style="display:none" name="id" type="text" value="<?=$pageID?>"/></br>
							<h6>About</h6>
							<input placeholder="About" name="about" type="text" value="<?= $pageloaded->about?>"/></br>
							<h6>Category</h6>
							 <span class="custom-dropdown">
							<select id="category" name="category">>
							<option value="<?= $pageloaded->category?>"><?= $pageloaded->category?></option>
...
<div class="User_Settings_Container" >
  ...
  $pages_load = $con->query("SELECT * FROM pages WHERE id = ".$pageID." AND user_id = ".$UsrID." ");?>
<?php while($pageloaded = $pages_load->fetch_object()): ?>  
              <form id="upload" method="post" action="elements/pageimageup.php" enctype="multipart/form-data">
                <input  id="upload_input"type="file"name="fileToUpload"/>
                <input placeholder="Name" style="display:none" name="relation_id" type="text" value="<?=$pageID?>"/>
<center><button name="Update" class="UsrSettingsBtn" id="update" value="Update">Update</button></center>
          <?php endwhile;?>
            </div>
            <div class="col-xs-6">
...
<div class="User_Settings_Container" >
  <center><h5>Page Details</h5></center>
  <div class="row">
    <div class="user_Desktop_Settings">
      <div class="col-xs-6">
        <div class="SettingsUsrInput">
