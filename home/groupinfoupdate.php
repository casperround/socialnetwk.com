...
<body>
	...
	<div class="CreatePageCont">
		<div class="CPageCont1">
			<form id="upload" method="post"  class="form-horizontal"action="http://www.socialnetwk.com/home/cgroupinfo.php" enctype="multipart/form-data">
				<fieldset>
					...
					$pagedetailsload = $db->query("SELECT * FROM groups WHERE id='".$id."'");?>
