...
<body class="align">
  ...
  <center><img src="https://www.socialnetwk.com/images/socialnetwk.png"></center>
    <div class="grid__container">

      <form action="register_post.php" method="post" class="form form--login">
      
        <div class="form__field">
          <label class="fontawesome-user" for="login__username"><span class="hidden">Username</span></label>
          <input name="email" id="login__username" type="text" class="form__input" placeholder="Email" required>
        </div>

        <div class="form__field">
          <label class="fontawesome-user" for="login__username"><span class="hidden">Username</span></label>
          <input name="username" id="login__username" type="text" class="form__input" placeholder="Username" required>
        </div>
      ...
      <p class="text--center">Already a member? <a href="index.php">Login now</a> <span class="fontawesome-arrow-right"></span></p>
